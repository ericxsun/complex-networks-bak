function write_edge2gml(edge, directed, file_name, vcolor, ecolor)
%WRITE_EDGE2GML write the edge list to gml format.
%
%Syntax: 
% WRITE_EDGE2GML(edge, directed, file_name, vcolor, ecolor)
%
...
%
%See also: read_pajek, write_edge2pajek, read_gml
