function edge = CAmodel_growing(m0, m, n_nodes)
%CAMODEL_GROWING generate an undirected connected graph according to the 
%clustering preferencial attachment model.
%
%Syntax: 
% edge = CAMODEL_GROWING(m0, m, n_nodes)
%
