function bs = betweenness_of_node(edge, directed)
%BETWEENNESS_OF_NODE calculate the betweenness of each NODE.
%
%Syntax: 
% bs = BETWEENNESS_OF_NODE(edge, directed)
%
